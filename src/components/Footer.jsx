  ...
  return (
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      ...
      <div className="w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#434249]">
        <p className="font-poppins font-normal text-center text-[18px] leading-[27px] text-dimWhite"> 2023 WooBank. All Rights Reserved. By <a href="https://github.com/tnajim" target="_blank" rel="noreferrer">tnajim</a></p>
